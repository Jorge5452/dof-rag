"""
Script para verificar la configuración y conexión con clientes de IA.

Uso:
    python -m test.config.test_config
"""
...
def test_config():
    """Prueba la configuración y conexión con clientes de IA"""
